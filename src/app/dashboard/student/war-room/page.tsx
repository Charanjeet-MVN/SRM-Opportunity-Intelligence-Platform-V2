...
import PlacementWarRoomClient from "@/components/dashboard/PlacementWarRoomClient";

export const metadata = {
  title: "AI Placement War Room - SRM Opportunity Intelligence Platform",
  description: "Ultimate placement preparation command center. Track company mock interviews, pipelines, and weakness detector plans.",
};

export default function StudentWarRoomPage() {
  return (
        ...
        <div className="relative z-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="space-y-2">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-[11px] font-mono bg-zinc-900 border border-zinc-800 text-zinc-300">
              ...
              <span className="text-zinc-500 text-[10px]">Real-Time Mock Diagnostics</span>
            </div>
            ...
            <p className="text-xs sm:text-sm text-zinc-400 font-light leading-relaxed max-w-xl">
              Evaluate mock interview diagnostics, select specialized target company prep trackers, check weakness detector plans, and monitor active application pipeline funnels.
            </p>
          </div>
        </div>
      </div>
