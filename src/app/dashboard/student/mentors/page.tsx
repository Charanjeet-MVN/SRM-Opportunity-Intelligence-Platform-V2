...
import MentorNetworkClient from "@/components/dashboard/MentorNetworkClient";

export const metadata = {
  title: "AI Mentor Network & Expert Twins - SRM Opportunity Intelligence Platform",
  description: "Bridges student opportunities with active alumni directories, generative Expert Twins, question submission logs, and guides databases.",
};
        ...
        <div className="relative z-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="space-y-2">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-[11px] font-mono bg-zinc-900 border border-zinc-800 text-zinc-300">
              ...
              <span className="text-zinc-500 text-[10px]">Alumni Discovery & Expert Twins</span>
            </div>
            <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-zinc-100">
              AI Mentor Network & Expert Twin Ecosystem
            </h1>
            <p className="text-xs sm:text-sm text-zinc-400 font-light leading-relaxed max-w-xl">
              Chat with virtual expert twins to analyze missing roadmap credentials, browse filterable alumni directories, submit queries to the network, and read success experiences.
            </p>
          </div>
        </div>
      </div>
