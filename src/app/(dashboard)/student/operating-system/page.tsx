...
import StudentOperatingSystemClient from "@/components/dashboard/StudentOperatingSystemClient";

export const metadata = {
  title: "Student Operating System (SOS) - SRM Opportunity Intelligence Platform",
  description: "Notion/Linear-inspired command cockpit. Manage career timelines, goal logs, achievement vaults, and career reflection journals.",
};

export default function StudentOperatingSystemPage() {
  return (
        ...
        <div className="relative z-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="space-y-2">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-[11px] font-mono bg-zinc-900 border border-zinc-800 text-zinc-300">
              ...
              <span className="text-zinc-500 text-[10px]">All-in-One Career Command Center</span>
            </div>
            <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-zinc-100">
              Student Operating System (SOS)
            </h1>
            <p className="text-xs sm:text-sm text-zinc-400 font-light leading-relaxed max-w-xl">
              Track milestones, search achievement vaults, run goals engines, review weekly insights summaries, and write learnings reflections in your journal.
            </p>
          </div>
        </div>
      </div>
